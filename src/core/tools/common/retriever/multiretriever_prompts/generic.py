...
If necessary, ask clarifying questions to the user. Include in-text citations as numbers in square brackets, e.g., [2]. 
...
This tool provides comprehensive answers by retrieving and reranking information from multiple data sources.
"""
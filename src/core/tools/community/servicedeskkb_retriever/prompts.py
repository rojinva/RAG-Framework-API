...
Provide answers to Lam Research employees' questions using ONLY the facts found in the list of sources. 
...
Useful for providing concise, source-based answers to Lam Research employees' questions about Service Desk knowledge articles and ticket data.
"""

...
"""
SABRE3D_EPL_INSTRUCTION_PROMPT = """When answering questions from Lam Research employees, use only the information found in the provided list of sources and be as descriptive as possible.
...
"""
SABRE3D_EPL_TOOL_DESCRIPTION_PROMPT =  """This tool is useful for providing concise, source-based answers to Lam Research employees' questions about SABRE3D. SABRE3D is a cutting-edge solution for advanced packaging applications, addressing the challenges of  wafer-level packaging (WLP) and through-silicon via (TSV) structures while delivering high-quality films, improved productivity, and cost efficiency. It plays a vital role in enabling the miniaturization and enhanced performance of modern electronic devices.
"""
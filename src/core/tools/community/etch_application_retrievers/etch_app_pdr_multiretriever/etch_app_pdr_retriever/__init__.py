...
tool_spec.tool_name = "etch_app_pdr_retriever"
tool_spec.search_config["filter"] = "Application eq 'PDR'"

etch_app_pdr_retriever_tool = LamBotRetrieverTool.from_tool_spec(tool_spec)
register_tool(etch_app_pdr_retriever_tool)
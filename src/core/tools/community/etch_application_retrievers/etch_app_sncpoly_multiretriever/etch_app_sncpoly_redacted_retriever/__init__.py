...
tool_spec.tool_name = "etch_app_sncpoly_redacted_retriever"
tool_spec.search_config["filter"] = "Application eq 'SNCPoly'"

etch_app_sncpoly_redacted_retriever_tool = LamBotRetrieverTool.from_tool_spec(tool_spec)
register_tool(etch_app_sncpoly_redacted_retriever_tool)
...
Useful for providing concise, source-based answers to Lam Research employees' questions about documents associated with triaging an Escalation ticket. These documents include CCI considerations and are accessible to privileged users validated by their functional location(s) of work per their Lam UserID.
"""

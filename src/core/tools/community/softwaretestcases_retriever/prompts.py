...
Useful for providing concise, source-based answers to Lam Research employees' questions about software test cases. These documents are used to identify, track, and resolve issues related to parts, processes, or systems, and can include information such as identification of issues, root cause analysis (RCA), and solutions/corrective actions.
"""

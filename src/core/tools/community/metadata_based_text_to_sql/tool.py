from .abstraction.text_to_sql_tool_spec_model import TextToSQLToolSpec, TextToSQLRetrieverSpec
from .abstraction.texttosql_tool import LamBotTextToSQLTool
from .prompts import (
...
tool_spec = TextToSQLToolSpec(
    ...
    metadata_retriever_spec=TextToSQLRetrieverSpec(
        index_name="index-oai-text2sqlmetadata",
        search_config={
            "search": "query-to-be-replaced-by-retriever",
            "vectorQueries": [{"kind": "text", "k": 9, "fields": "chunk_vector"}],
            "queryType": "semantic",
    ...
    sample_queries_retriever_spec=TextToSQLRetrieverSpec(
        index_name="index-oai-text2sqlsamplequeries",
        search_config={
            "search": "query-to-be-replaced-by-retriever",
            "vectorQueries": [{"kind": "text", "k": 9, "fields": "chunk_vector"}],
            "queryType": "semantic",
...
text_to_sql_retriever_tool = LamBotTextToSQLTool.from_tool_spec(tool_spec)
